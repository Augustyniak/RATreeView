...
Check out the demo for example usage of library. Make sure you read the [RATreeView documentation on Cocoa Docs](http://cocoadocs.org/docsets/RATreeView/0.9.0).
...
Documentation is available on [CocoaPods](http://cocoadocs.org/docsets/RATreeView/0.9.0).
